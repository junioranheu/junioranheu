...
* ⚡  I'm a fullstack dev experienced in C#, .NET Framework/Core, React.js/Next.js, Angular, MySQL and SQL Server — moreover I used a bit of React Native and Unit Testing (xUnit in .NET);
